...
class MealRepositoryImpl @Inject constructor(
    ...
    override fun getMealsByName(name: String) : Either<Failure, MealsResponse> {
        val result = makeRequest(networkHandler, mealApi.getMealsByName(name), { it }, MealsResponse(emptyList())) //Api result
    ...
    override fun getMealsByCategories(category: String) : Either<Failure, MealsResponse> {
        val result = makeRequest(networkHandler, mealApi.getMealsByCategories(category), { it }, MealsResponse(emptyList())) //Api result
    ...
    override fun getMealsRandom(name: String ) : Either<Failure, MealsResponse> {
        val result = makeRequest(networkHandler, mealApi.getMealsRandom(name), { it }, MealsResponse(emptyList())) //Api result
