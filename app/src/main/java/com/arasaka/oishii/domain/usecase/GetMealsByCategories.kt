...
class GetMealsByCategories @Inject constructor(private val mealRepository: MealRepository) :
    UseCase<MealsResponse, String>()  {
    override suspend fun run(params: String ) = mealRepository.getMealsByCategories(params);
}